...
experiment_name = 'method1_specialist_e1'
n_hidden_neurons = 10
...
if run_mode == 'test':
    exp_test_path = "method1_specialist_e1/experiment_1"
    env = Environment(experiment_name=exp_test_path,
                      enemies=[1],
                      playermode="ai",
                      ...
                      level=2,
                      speed="fastest",
                      visuals=True)  # Make True to watch the game in test mode
    best_solution = np.loadtxt(exp_test_path+'/best.txt')
...
for exp in range(1, 11):
    ...
    env = Environment(experiment_name=exp_fullpath,
                      ...
                      level=2,
                      speed="fastest",
                      visuals=False)  # Make True to watch the game in testmode
